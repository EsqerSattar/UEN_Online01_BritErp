...
//        String filePath = System.getProperty("user.dir") + "\\test-output\\report.html";
        ...
        report.setSystemInfo("QA Engineer", "Esqer Sattar");

        htmlReporter.config().setDocumentTitle("BRIT ERP Reports");
        htmlReporter.config().setReportName("BRIT ERP Manufacturing Module Automated Test Reports");
